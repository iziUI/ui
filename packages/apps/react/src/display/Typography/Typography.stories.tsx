  ...
  render: () => {
    return (
      <Stack flexDirection="column">
        <Typography style={{ margin: 0 }} variant="h5" color="primary.main">primary.main</Typography>
        ...
        <Typography style={{ margin: 0 }} variant="h5" color="secondary.main">secondary.main</Typography>
        ...
        <Typography style={{ margin: 0 }} variant="h5" color="error.main">error.main</Typography>
        ...
        <Typography style={{ margin: 0 }} variant="h5" color="warning.main">warning.main</Typography>
        ...
        <Typography style={{ margin: 0 }} variant="h5" color="info.main">info.main</Typography>
        ...
        <Typography style={{ margin: 0 }} variant="h5" color="success.main">success.main</Typography>
